...
\begin{figure}[H]
    \centering
    \subcaptionbox{До 1го тика}{\includegraphics[scale=0.5]{images/image-22.png}} \\
    \subcaptionbox{1й тик}{\includegraphics[scale=0.5]{images/image-23.png}} \\
    \subcaptionbox{2й тик}{\includegraphics[scale=0.5]{images/image-24.png}} \\
    \subcaptionbox{3й тик}{\includegraphics[scale=0.5]{images/image-25.png}} \\
    \caption{Демонстрация сдвига регистра}
\end{figure}
